...
contract ERC20 is Ownable, IERC20 {
    ...
    function _initERC20(address owner_, string calldata name_, string calldata symbol_, uint8 decimals_) internal {
        _initOwner(owner_);
...
contract TokenStakableImplementation is ERC20, Initializable
{
    ...
    mapping(address => uint256) public assets; // address(0) = ETH
    ...
    function initialize(address _owner,
                        ...
                        uint256[] calldata _assetPrices) external initializer
    {
        _initERC20(_owner, _name, _symbol, ERC20(_lockedToken).decimals());
